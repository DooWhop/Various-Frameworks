...
public class Draw {
	...
	private String useSignTime;
	
	private String withholdProtocol;
	
	private String withholdProtocolTime;
	
	private String borrowProtocol;
	
	private String borrowProtocolTime;
	...
	public String getUseSignTime() {
		return useSignTime;
	}

	public void setUseSignTime(String useSignTime) {
	...
	public String getWithholdProtocolTime() {
		return withholdProtocolTime;
	}

	public void setWithholdProtocolTime(String withholdProtocolTime) {
	...
	public String getBorrowProtocolTime() {
		return borrowProtocolTime;
	}

	public void setBorrowProtocolTime(String borrowProtocolTime) {
